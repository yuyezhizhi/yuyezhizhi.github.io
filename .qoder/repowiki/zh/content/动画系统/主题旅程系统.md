...
## 更新摘要
**变更内容**
- 旅程播放器架构重构：从各页面组件迁移到App.vue全局组件
- 实现统一的旅程管理和跨路由访问
- 优化UI布局和响应式设计
- 新增全局旅程状态管理
- 改进旅程播放器的定位和交互设计
...
- [src/views/JourneysPage.vue:1-305](file://src/views/JourneysPage.vue#L1-L305)
...
- **波与能量主题**：波干涉、彩虹波浪、音频可视化
- **冥想治愈主题**：气泡、流沙、星光舞蹈
- **生成艺术主题**：噪声地形、细胞自动机、流动球体
...
- [src/data/journeys.js:1-182](file://src/data/journeys.js#L1-L182)
...
- [src/views/JourneysPage.vue:267-303](file://src/views/JourneysPage.vue#L267-L303)
