...
**图表来源**
- [src/router/index.js:226-239](file://src/router/index.js#L226-L239)
...
**更新** AudioWheel.vue 实现了音频可视化功能：

#### 音频可视化组件
AudioWheel.vue 集成了 AudioUploader 组件，提供音频上传和可视化功能：

```mermaid
flowchart TD
AudioWheel[AudioWheel.vue] --> AudioUploader[AudioUploader组件]
AudioWheel --> P5Canvas[p5.js画布]
AudioWheel --> Controls[控制面板]
