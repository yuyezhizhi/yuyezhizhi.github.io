...
export default [
  ...
  // AI相关面试题
  {
    id: 101,
    category: 'AI',
    question: 'AI在前端开发中有哪些主要应用场景？',
    answer: 'AI在前端开发中的主要应用场景包括：代码生成与补全、UI/UX设计辅助、bug检测与修复、性能优化、文档生成、无障碍访问优化、内容翻译与本地化、个性化推荐、自然语言交互等。'
  },
  {
    id: 102,
    category: 'AI',
    question: '请列举几种常用的AI前端开发工具，并简述其功能。',
    answer: '常用的AI前端开发工具包括：1. GitHub Copilot - 实时代码建议和生成；2. ChatGPT - 自然语言交互的AI助手，可用于代码生成、问题解答；3. Codeium - 免费的AI编程助手，支持多种语言；4. TabNine - AI驱动的代码补全工具；5. Adobe Firefly - AI设计工具，用于生成图像和设计元素；6. Figma AI - 集成在Figma中的AI设计助手；7. Snyk - AI辅助的代码安全检测工具。'
  },
  {
    id: 103,
    category: 'AI',
    question: 'AI生成代码的主要优缺点是什么？',
    answer: '优点：提高开发效率、减少重复劳动、提供新思路、降低入门门槛、减少语法错误。缺点：质量参差不齐、缺乏上下文理解、可能存在安全漏洞、知识产权问题、过度依赖可能导致编程能力下降。'
  },
  {
    id: 104,
    category: 'AI',
    question: '如何有效使用AI辅助前端开发？',
    answer: '有效使用AI辅助前端开发的方法包括：1. 提供清晰具体的问题描述；2. 对AI生成的代码进行审查和测试；3. 将AI生成的代码作为起点，进行手动优化；4. 结合官方文档使用；5. 学习AI生成代码中的优秀实践；6. 注意保护敏感信息；7. 不要完全依赖AI，保持独立思考能力。'
  },
  {
    id: 105,
    category: 'AI',
    question: 'AI对前端开发者的职业发展有什么影响？',
    answer: 'AI对前端开发者的职业发展影响包括：1. 提高开发效率，使开发者能够专注于更复杂的问题；2. 改变工作内容，从代码编写转向需求分析和解决方案设计；3. 要求开发者掌握AI工具的使用；4. 促进技能升级，需要学习更多高级概念和架构设计；5. 创造新的职业机会，如AI工具集成专家、AI驱动产品开发等。'
  },
  {
    id: 106,
    category: 'AI',
    question: '什么是AI驱动的用户体验设计？它与传统UX设计有什么区别？',
    answer: 'AI驱动的用户体验设计是指利用人工智能技术来优化用户体验的设计方法。与传统UX设计相比，它可以：1. 基于大数据进行个性化设计；2. 实时分析用户行为并调整界面；3. 预测用户需求并提供主动建议；4. 自动化某些设计流程，如生成设计变体；5. 提供更自然的交互方式，如语音和手势控制。'
  },
  {
    id: 107,
    category: 'AI',
    question: '如何评估AI生成代码的质量？',
    answer: '评估AI生成代码质量的方法包括：1. 功能测试，确保代码满足需求；2. 性能测试，检查代码的运行效率；3. 代码审查，检查代码结构、可读性和可维护性；4. 安全检查，查找潜在的安全漏洞；5. 单元测试覆盖率，确保代码被充分测试；6. 与最佳实践对比，检查是否符合行业标准；7. 长期维护性评估，考虑代码的扩展性和兼容性。'
  },
  {
    id: 108,
    category: 'AI',
    question: 'AI在前端性能优化中有哪些应用？',
    answer: 'AI在前端性能优化中的应用包括：1. 自动识别性能瓶颈；2. 智能资源加载，如预加载、懒加载策略的优化；3. 图像和资源的智能压缩；4. 代码分割和打包优化；5. 缓存策略的智能调整；6. 用户行为预测，提前加载可能需要的资源；7. 渲染性能的智能优化，如虚拟滚动、按需渲染的自动实现。'
  },
  {
    id: 109,
    category: 'AI',
    question: '使用AI生成代码时需要注意哪些安全问题？',
    answer: '使用AI生成代码时需要注意的安全问题包括：1. 防止敏感信息泄露，如API密钥、密码等；2. 检查生成代码中的安全漏洞，如SQL注入、XSS攻击等；3. 确保生成代码符合安全编码规范；4. 注意依赖包的安全性；5. 了解AI生成代码的版权和许可问题；6. 避免生成包含后门或恶意代码的程序；7. 对生成的代码进行安全扫描和审计。'
  },
  {
    id: 110,
    category: 'AI',
    question: '未来AI在前端开发中的发展趋势是什么？',
    answer: '未来AI在前端开发中的发展趋势包括：1. 更深入地集成到开发工作流中；2. 能够理解更复杂的业务需求并生成完整的应用；3. AI辅助的前端测试将更加智能和高效；4. 低代码/无代码平台将更加依赖AI技术；5. 自然语言编程将更加普及；6. AI将帮助实现更智能的用户交互和个性化体验；7. 前端开发者将更多地关注AI工具的训练和定制。'
  }
];